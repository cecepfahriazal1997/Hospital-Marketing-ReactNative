...
const MarketingAnalyticList = ({navigation}) => {
	const [modalVisible, setModalVisible] = useState(false);
	const [currTab, setCurrTab] = useState('month');
  
  const menuItem = [
    {
      indicator: 'Pelayanan Rawat Jalan',
      information: 'Rata-rata kunjungan / kenal',
      decision: '(Pelayanan) = P1 Pengembangan Pelayanan',
    },
    {
      indicator: 'Pelayanan Rawat Jalan',
      information: 'Persentase pelayanan spesialistik',
      decision: '(Pelayanan) = P1 Pengembangan Pelayanan',
    },
    {
      indicator: 'Pelayanan Rawat Jalan',
  ...
  const headerItem = () => (
    <View>
      ...
      <View style={{ flexDirection:'row', flex: 1, gap: 10}}>
        <Input placeholder='Cari Akuntansi Manajemen' styleIcon={{ name: 'search', color: colors.gray, size: 16 }} backgroundColor="grayLightLevel2"></Input>
...
export default MarketingAnalyticList;
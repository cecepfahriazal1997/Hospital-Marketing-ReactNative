...
const AccountingList = ({navigation}) => {
	const [modalVisible, setModalVisible] = useState(false);
	const [currTab, setCurrTab] = useState('month');
  
  const menuItem = [
    {
      indicator: 'Penerimaan rawat inap',
      information: 'VIP',
      decision: '(Tarif) = P3 Kebijaksanaan tarif',
    },
    {
      indicator: 'Penerimaan rawat inap',
      information: 'Kelas II',
      decision: '(Pasien) = Kebijaksanaan tarif',
    },
    {
      indicator: 'Penerimaan rawat inap',
      information: 'S. VIP',

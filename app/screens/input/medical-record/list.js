  ...
  const menuItem = [
    {
      indicator: 'Umur',
      information: '13-64',
      decision: '(Pasien) = P7 Sasaran utama pasien',
    },
    {
      indicator: 'Umur',
      information: '> 65',
  ...
  const headerItem = () => (
    <View>
      ...
      <View style={{ flexDirection:'row', flex: 1, gap: 10}}>
        <Input placeholder='Cari Rekam Medis' styleIcon={{ name: 'search', color: colors.gray, size: 16 }} backgroundColor="grayLightLevel2"></Input>
